...
public class ChatActivity extends Activity {
    ...
    private List<oneMsg> msglist;   //装载消息的List

    private BaseAdapter adapter;

    private String userJID;       //用户标志  

    private String userName;      //用户昵称

    private org.jivesoftware.smack.Chat chat;

    private myDBHelper openHelper;  //数据库封装类
    ...
    private class myAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (msglist.get(position).getDir().equals("IN")) {
                convertView = this.inflater.inflate(R.layout.chat_msg_in, null);
            } else {
                convertView = this.inflater.inflate(R.layout.chat_msg_out, null);
            }
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    String[] args = new String[] {
                            Connect.getInstance().USERNAME, userName, Timer.getDate(), m.getBody(),
                            "OUT"
                    };
    ...
    private class myMessageListener implements MessageListener {
        ...
        public void processMessage(org.jivesoftware.smack.Chat chat0, Message msg) {
            ...
            if (msg.getFrom().contains(userName)) { // 是否是发给userName的消息
                ...
                String[] args = new String[] {
                        userName, Connect.getInstance().USERNAME, Timer.getDate(), msg.getBody(),
                        "IN"
                };
